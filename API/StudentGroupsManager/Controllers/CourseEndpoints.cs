...
public static class CourseEndpoints
{
    public static void MapCourseEndpoints (this IEndpointRouteBuilder routes)
    {
        ...
        group.MapGet("/{id}", async Task<Results<Ok<Course>, NotFound>> (int id, StudentGroupsManagerContext db) =>
        {
        ...
        group.MapPut("/{id}", async Task<Results<Ok, NotFound>> (int id, Course course, StudentGroupsManagerContext db) =>
        {
            var affected = await db.Courses
                .Where(model => model.Id == id)
                .ExecuteUpdateAsync(setters => setters
                  .SetProperty(m => m.NameCourse, course.NameCourse)
        ...
        group.MapPost("/", async (Course course, StudentGroupsManagerContext db) =>
        {
